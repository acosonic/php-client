...
/**
 * CartModelState Class Doc Comment
 *
 * @category Class
 * @description Shipping state used for tax calculation.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CartModelState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartModel_state';
    ...
    */
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Indicates if state is enabled.
     *
     * @return self
     */
