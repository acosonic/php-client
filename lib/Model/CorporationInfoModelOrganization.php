...
/**
 * CorporationInfoModelOrganization Class Doc Comment
 *
 * @category Class
 ...
 */
class CorporationInfoModelOrganization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CorporationInfoModel_organization';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Oragnization name.
     *
     * @return self
     */
     ...
     * Sets owner_name
     *
     * @param string|null $owner_name Oragnization owner name.
     *
     * @return self
     */
