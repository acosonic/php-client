...
/**
 * CreateOrderCustomerModel Class Doc Comment
 *
 * @category Class
 * @description Contains information about customer for order.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateOrderCustomerModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrderCustomerModel';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateOrderCustomerModel., must be bigger than or equal to 1.');
        }
