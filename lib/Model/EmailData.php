...
class EmailData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('recepient', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['recepient'];
    }

    /**
     * Sets recepient
     *
     * @param string|null $recepient Recepient E-mail address.
     *
     * @return self
     */
    public function setRecepient($recepient)
    {
        ...
        if (is_null($recepient)) {
            array_push($this->openAPINullablesSetToNull, 'recepient');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recepient', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['recepient'] = $recepient;
     ...
     * Sets subject
     *
     * @param string|null $subject E-mail subject.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body E-mail body.
     *
     * @return self
     */
     ...
     * Sets is_body_html
     *
     * @param bool|null $is_body_html Indicates if e-mail body is in html format.
     *
     * @return self
     */
