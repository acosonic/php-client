...
/**
 * ExternalCredentialsModel Class Doc Comment
 *
 * @category Class
 * @description Contains information required for external login.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExternalCredentialsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalCredentialsModel';
    ...
    protected static $openAPITypes = [
        'provider' => '\OpenAPI\Client\Model\ExternalCredentialsModelProvider',
        'token' => 'string',
        'persistent' => 'bool'
    ];
    ...
    */
     ...
     * Gets provider
     *
     * @return \OpenAPI\Client\Model\ExternalCredentialsModelProvider
     */
     ...
     * Sets provider
     *
     * @param \OpenAPI\Client\Model\ExternalCredentialsModelProvider $provider provider
     *
     * @return self
     */
    ...
    public function setToken($token)
    {
        ...
        if ((mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling ExternalCredentialsModel., must be bigger than or equal to 1.');
        }
