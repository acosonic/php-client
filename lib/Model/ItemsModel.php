...
/**
 * ItemsModel Class Doc Comment
 *
 * @category Class
 * @description Contains a list of id&#39;s.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ItemsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemsModel';
    ...
    */
     ...
     * Sets items
     *
     * @param string[]|null $items List of id's.
     *
     * @return self
     */
