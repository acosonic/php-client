...
/**
 * LoginVerificationModel Class Doc Comment
 *
 * @category Class
 * @description Contains information for completing two factor authentication.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LoginVerificationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginVerificationModel';
    ...
    */
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 200)) {
            throw new \InvalidArgumentException('invalid length for $email when calling LoginVerificationModel., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling LoginVerificationModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCode($code)
    {
        if ((mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling LoginVerificationModel., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling LoginVerificationModel., must be bigger than or equal to 0.');
        }
