...
/**
 * PaginationQuery Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginationQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginationQuery';
    ...
    */
    ...
    public function setSort($sort)
    {
        if (!is_null($sort) && (mb_strlen($sort) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sort when calling PaginationQuery., must be smaller than or equal to 200.');
        }
        if (!is_null($sort) && (mb_strlen($sort) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sort when calling PaginationQuery., must be bigger than or equal to 0.');
        }
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && ($page > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $page when calling PaginationQuery., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($page) && ($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling PaginationQuery., must be bigger than or equal to 1.');
        }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling PaginationQuery., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($page_size) && ($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling PaginationQuery., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxItemCount($max_item_count)
    {
        ...
        if (!is_null($max_item_count) && ($max_item_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $max_item_count when calling PaginationQuery., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($max_item_count) && ($max_item_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_item_count when calling PaginationQuery., must be bigger than or equal to 1.');
        }
