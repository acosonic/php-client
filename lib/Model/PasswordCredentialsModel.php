...
/**
 * PasswordCredentialsModel Class Doc Comment
 *
 * @category Class
 ...
 */
class PasswordCredentialsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PasswordCredentialsModel';
    ...
    */
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 200)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PasswordCredentialsModel., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PasswordCredentialsModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPassword($password)
    {
        if ((mb_strlen($password) > 100)) {
            throw new \InvalidArgumentException('invalid length for $password when calling PasswordCredentialsModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($password) < 0)) {
            throw new \InvalidArgumentException('invalid length for $password when calling PasswordCredentialsModel., must be bigger than or equal to 0.');
        }
