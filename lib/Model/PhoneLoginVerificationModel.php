...
/**
 * PhoneLoginVerificationModel Class Doc Comment
 *
 * @category Class
 * @description Contains information required for phone login verification.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PhoneLoginVerificationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhoneLoginVerificationModel';
    ...
    */
    ...
    public function setCode($code)
    {
        if ((mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PhoneLoginVerificationModel., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PhoneLoginVerificationModel., must be bigger than or equal to 0.');
        }
