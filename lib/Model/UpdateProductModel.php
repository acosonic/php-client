...
/**
 * UpdateProductModel Class Doc Comment
 *
 * @category Class
 * @description Contains information for creating/updating product.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateProductModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateProductModel';
    ...
    protected static $openAPITypes = [
        ...
        'tax_disabled' => 'bool',
        'attributes' => 'string[]',
        'options' => '\OpenAPI\Client\Model\UpdateProductOptionModel[]',
        'terms' => '\OpenAPI\Client\Model\UpdateProductTermModel[]',
        'gifts' => 'string[]',
        'upsells' => 'string[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('page_type_id', $data ?? [], null);
    ...
    */
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Enable or disable product.
     *
     * @return self
     */
     ...
     * Sets category_id
     *
     * @param string|null $category_id Product category ID.
     *
     * @return self
     */
     ...
     *
     * @param int|null $google_category_id Product google category ID.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProductModel., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling UpdateProductModel., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['page_type_id'];
    }

    /**
     * Sets page_type_id
     *
     * @param int|null $page_type_id Product page type ID.
     *
     * @return self
     */
    public function setPageTypeId($page_type_id)
    {

        if (is_null($page_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'page_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('page_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['page_type_id'] = $page_type_id;
     ...
     *
     * @param bool|null $enable_comments Indicates if product comments are enabled.
     *
     * @return self
     */
     ...
     * Sets enable_upsell
     *
     * @param bool|null $enable_upsell Indicates if product upsell is enabled.
     *
     * @return self
     */
     ...
     * Sets enable_intro
     *
     * @param bool|null $enable_intro Indicates if product intro is enabled.
     *
     * @return self
     */
     ...
     * Sets enable_sweep
     *
     * @param bool|null $enable_sweep Indicates if product sweep is enabled.
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\UpdateProductOptionModel[]|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\UpdateProductOptionModel[]|null $options Product options.
     *
     * @return self
     */
     ...
     * Gets terms
     *
     * @return \OpenAPI\Client\Model\UpdateProductTermModel[]|null
     */
     ...
     * Sets terms
     *
     * @param \OpenAPI\Client\Model\UpdateProductTermModel[]|null $terms Product terms.
     *
     * @return self
     */
     ...
     * Sets gifts
     *
     * @param string[]|null $gifts Gift products.
     *
     * @return self
     */
     ...
     * Sets upsells
     *
     * @param string[]|null $upsells Upsell products.
     *
     * @return self
     */
