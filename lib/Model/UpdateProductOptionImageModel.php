...
/**
 * UpdateProductOptionImageModel Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateProductOptionImageModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateProductOptionImageModel';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Product option image ID to update, when not specified creates new option image.
     *
     * @return self
     */
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Enable or disable product option image.
     *
     * @return self
     */
