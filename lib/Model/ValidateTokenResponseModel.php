...
/**
 * ValidateTokenResponseModel Class Doc Comment
 *
 * @category Class
 * @description Contains information about token validation.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ValidateTokenResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidateTokenResponseModel';
    ...
    */
     ...
     * Sets is_valid
     *
     * @param bool|null $is_valid Is token valid.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Reason for invalid token.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $expiration_time UTC time when token expires.
     *
     * @return self
     */
